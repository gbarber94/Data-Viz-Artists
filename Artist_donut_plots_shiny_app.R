...
ui <- fluidPage(
  ...
  fluidRow(div(column(plotlyOutput("g1p1"), width = 4),
  ...
  fluidRow(div(column(plotlyOutput("g2p1"), width = 4),
  ...
  fluidRow(div(column(plotlyOutput("g3p1"), width = 4),
  ...
  fluidRow(div(column(plotlyOutput("g4p1"), width = 4),
...
server <- shinyServer(function(input, output, session) {
  ...
  output$g1p1 <- renderPlotly({plot_vec[[1]] %>% layout(legend = list(x = 0.29,y = 0.5, align = 'right', bgcolor = 'rgba(0,0,0,0)', font = list(size = 9)))%>% layout(height = 400)})
  ...
  output$g2p1 <- renderPlotly({plot_vec2[[1]] %>% layout(legend = list(x = 0.29,y = 0.5, align = 'right', bgcolor = 'rgba(0,0,0,0)', font = list(size = 9)))%>% layout(height = 400)})
  ...
  output$g3p1 <- renderPlotly({plot_vec3[[1]] %>% layout(legend = list(x = 0.29,y = 0.5, align = 'right', bgcolor = 'rgba(0,0,0,0)', font = list(size = 9)))%>% layout(height = 400)})
  ...
  output$g4p1 <- renderPlotly({plot_vec4[[1]] %>% layout(legend = list(x = 0.29,y = 0.5, align = 'right', bgcolor = 'rgba(0,0,0,0)', font = list(size = 9)))%>% layout(height = 400)})
  ...
  output$g5p1 <- renderPlotly({plot_vec4[[1]] %>% layout(legend = list(x = 0.29,y = 0.5, align = 'right', bgcolor = 'rgba(0,0,0,0)', font = list(size = 9)))%>% layout(height = 400)})
